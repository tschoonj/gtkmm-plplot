  ...
  namespace PLplot {
     ...
     */
     ...
     public:
      /** Constructor
       *
       * This class provides a single constructor, which takes an existing PlotDataContourShades dataset to construct a plot.
       ...
       * The default corresponds to the plot taking up the full c
